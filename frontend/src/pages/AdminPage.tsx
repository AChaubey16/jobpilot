...
import { ShieldCheck, Server, Users, Cpu, Activity, Plus, Globe, Trash2, Edit, CheckCircle2, Search, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-white">SaaS Admin — Company Portal Crawler Management</h1>
          <p className="text-slate-400 text-sm">
            Manage the list of 50,000+ company career portal URLs monitored continuously by background Playwright agents.
          </p>
        </div>
        ...
        >
          ...
          <span>Add Company Career URL</span>
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="p-6 rounded-2xl glass-card space-y-1 border border-slate-800">
          ...
          <p className="text-3xl font-extrabold text-emerald-400">12 Workers Active</p>
        </div>
        <div className="p-6 rounded-2xl glass-card space-y-1 border border-slate-800">
      ...
      {/* Company Career URL Target Management Table */}
